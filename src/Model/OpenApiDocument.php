...
final class OpenApiDocument implements Extensible
{
     ...
     * @param \On1kel\OAS\Model\Collections\List\SecurityRequirementList|null $security          Требования безопасности (массив карт)
     * @param \On1kel\OAS\Model\Collections\List\TagList|null                 $tags              Теги
